...
public class CoffeeMachineGUIPayment extends JFrame {
    ...
    public  CoffeeMachineGUIPayment(CoffeeMachine coffeeMachine, CoffeeTypes type, DefaultTableModel tableModel) {
    ...
    class QuantityController implements ActionListener{
        ...
        QuantityController(CoffeeTypes type, JButton increaseQuantity, JButton decreaseQuantity) {
            this.type = type;
